...
def painel_admin():
    while True:
        ...
        dashboard_admin()
        print()
        print(f"{VERDE_BRILHANTE}01{RESET} Administração geral")
        print(f"{VERDE_BRILHANTE}02{RESET} Funcionários")
        print(f"{VERDE_BRILHANTE}03{RESET} Clientes / aprovações")
        print(f"{VERDE_BRILHANTE}04{RESET} Central de suporte")
        print(f"{VERDE_BRILHANTE}05{RESET} Alterar senha administrativa")
        print(f"{VERDE_BRILHANTE}06{RESET} Auditoria e logs")
        print(f"{VERDE_BRILHANTE}07{RESET} Backup do banco")
        print(f"{VERDE_BRILHANTE}08{RESET} Manutenção")
        print(f"{VERDE_BRILHANTE}09{RESET} Ferramentas de laboratório")
        print(f"{VERMELHO_SANGUE}00{RESET} Encerrar sessão administrativa")
        linha()
        ...
        if opcao in ("1", "01"):
            limpar_tela()
            dashboard_admin()
            print("\nO administrador possui acesso integral ao painel.")
            pausar()
            ...
            print(f"{CIANO}Ferramentas do laboratório ficam no painel de cliente autorizado.{RESET}")
            pausar()
...
def menu_principal():
    while True:
        ...
        print()
        print(f"{CIANO}--- [ SWINDLER CORPORATE ACCESS ] ---{RESET}")
        print(f"{VERDE_BRILHANTE}{'01'}{RESET} Login Administrativo")
        print(f"{VERDE_BRILHANTE}{'02'}{RESET} Login Funcionário")
        print(f"{VERDE_BRILHANTE}{'03'}{RESET} Login Cliente")
